    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                #print(x,y)
                if x>rx and x<(rx+80) and y>ry and y<(ry+80) and x1>rx and x1<(rx+80) and y1>ry and y1<(ry+80) and x2>rx and x2<(rx+80) and y2>ry and y2<(ry+80) and x3>rx and x3<(rx+80) and y3>ry and y3<(ry+80):
                    run = True
                # 將節點和骨架繪製到影像中
